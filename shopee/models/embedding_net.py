...
class EmbeddingNet(nn.Module):
    ...
    def forward(self, embedding):
        ...
        image_embedding = self.image_bn(image_embedding)

        if self.text_dim > 0:
            text_embedding = self.text_fc(text_embedding)
